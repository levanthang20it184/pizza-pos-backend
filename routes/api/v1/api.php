...
//            Route::post('/submit', 'DeliveryManReviewController@submit_review');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('products/all', 'CategoryController@get_all_products');
    });
    ...
    Route::group(['prefix' => 'customer'], function () {
        Route::group(['prefix' => 'order'], function () {
            Route::post('place-order-guest', 'OrderController@place_order_guest');
        });
    });
    ...
    Route::get('deliveryInfo/{uid}', function ($uid) {
        $address_autocomplete = DB::table('address_autocompletes')->where('uid', $uid)->get();
        return json_encode(array($address_autocomplete));
    });

    Route::get('run-artisan-command/{command}', [ArtisanController::class,'run_artisan_command'])->name('run-artisan-command');
