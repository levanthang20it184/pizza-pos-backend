...
//            ->whereBetween('created_at', [$from, $to])
        ...
        return view('branch-views.dashboard', compact('data', 'earning', 'order_statistics_chart', 'donut', 'categories','category'));
    }
    ...
    public function settings()
    {
        ...
        return view('branch-views.settings', compact('categories','category'));
    }
