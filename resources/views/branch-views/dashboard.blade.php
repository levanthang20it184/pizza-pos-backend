...
@push('css_or_js')
    ...
    <link rel="stylesheet" src="{{asset('public-assets/assets/admin')}}/vendor/apex/apexcharts.css"></link>
@endpush
            ...
            <div class="row justify-content-between align-items-center g-2 mb-3">
                <div class="col-auto">
                    <h4 class="d-flex align-items-center gap-10 mb-0">
                        <img width="20" class="avatar-img rounded-0" src="{{asset('public-assets/assets/admin/img/icons/business_analytics.png')}}" alt="Business Analytics">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-wrap gap-2 align-items-center">
                        <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                            <img width="20" class="avatar-img rounded-0" src="{{asset('public-assets/assets/admin/img/icons/earning_statistics.png')}}" alt="">
...
@push('script')
    <script src="{{asset('public-assets/assets/admin')}}/vendor/chart.js/dist/Chart.min.js"></script>
    <script src="{{asset('public-assets/assets/admin')}}/vendor/chart.js.extensions/chartjs-extensions.js"></script>
    <script src="{{asset('public-assets/assets/admin')}}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
    <script src="{{asset('public-assets/assets/admin')}}/vendor/apex/apexcharts.min.js"></script>
@endpush
