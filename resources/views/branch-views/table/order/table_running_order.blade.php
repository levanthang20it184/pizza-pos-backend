...
{{--                    <h2 class="">{{translate('Table Orders')}}<img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/all_orders.png')}}" alt=""> <span class="badge badge-soft-dark ml-2"></span></h2>--}}
                </div>
