                    ...
                    <form class="product-form" action="{{route('admin.product.bulk-import')}}" method="POST"
                        ...
                        <div class="rest-part">
                            <div class="d-flex flex-wrap justify-content-center gap-3">
                                ...
                                <a href="{{asset('public-assets/assets/product_bulk_format.xlsx')}}" download=""
                                        ...
                                        <div class="col-auto">
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img src="{{asset('public-assets/assets/admin/img/icons/drug_file.png')}}" alt="">
{{--                                                    <img src="{{asset('public-assets/assets/admin/img/icons/excel.png')}}" alt="">--}}
                                                </div>
    ...
    <script>
        $('#import-file').on('change', function(){
            if($(this)[0].files.length !== 0){
                $('.file--img').empty().append(`<div class="my-2"> <img width="200" src="{{asset('public-assets/assets/admin/img/icons/excel.png')}}" alt=""></div>`)
            }
        })
