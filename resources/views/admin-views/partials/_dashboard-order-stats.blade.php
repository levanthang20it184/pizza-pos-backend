...
<div class="col-sm-6 col-lg-3">
    <a href="{{route('admin.orders.list',['pending'])}}" class="dashboard--card">
        ...
        <img width="30" src="{{asset('public-assets/assets/admin/img/icons/pending.png')}}" class="dashboard--card__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a href="{{route('admin.orders.list',['confirmed'])}}" class="dashboard--card">
        ...
        <img width="30" src="{{asset('public-assets/assets/admin/img/icons/confirmed.png')}}" class="dashboard--card__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a href="{{route('admin.orders.list',['processing'])}}" class="dashboard--card">
        ...
        <img width="30" src="{{asset('public-assets/assets/admin/img/icons/packaging.png')}}" class="dashboard--card__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a href="{{route('admin.orders.list',['out_for_delivery'])}}" class="dashboard--card">
        ...
        <img width="30" src="{{asset('public-assets/assets/admin/img/icons/out_for_delivery.png')}}" class="dashboard--card__img" alt="">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="order-stats order-stats_pending" href="{{route('admin.orders.list',['delivered'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('public-assets/assets/admin/img/icons/delivered.png')}}" class="order-stats__img" alt="">
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="order-stats order-stats_canceled" href="{{route('admin.orders.list',['canceled'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('public-assets/assets/admin/img/icons/canceled.png')}}" class="order-stats__img" alt="">
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="order-stats order-stats_returned" href="{{route('admin.orders.list',['returned'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('public-assets/assets/admin/img/icons/returned.png')}}" class="order-stats__img" alt="">
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="order-stats order-stats_failed" href="{{route('admin.orders.list',['failed'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('public-assets/assets/admin/img/icons/failed_to_deliver.png')}}" class="order-stats__img" alt="">
