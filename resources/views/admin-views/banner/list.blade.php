    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/banner.png')}}" alt="">
                                            ...
                                            <div class="d-flex justify-content-center mt-4">
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img_drag upload-file__img">
                                                        <img width="465" id="viewer" src="{{asset('public-assets/assets/admin/img/icons/upload_img2.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-vertical-150" src="{{asset('storage/app/public/banner')}}/{{$banner['image']}}"
                                                onerror="this.src='{{asset('public-assets/assets/admin/img/900x400/img1.jpg')}}'">
                                        </td>
                                        <td>
