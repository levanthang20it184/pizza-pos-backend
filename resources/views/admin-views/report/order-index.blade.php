    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/order_report.png')}}" alt="">
            ...
            <div class="card-body">
                <div class="media flex-column flex-sm-row flex-wrap align-items-sm-center gap-4">
                    ...
                    <div class="avatar avatar-xl">
                        <img class="avatar-img" src="{{asset('public-assets/assets/admin')}}/svg/illustrations/order.png"
...
@push('script_2')
    ...
    <script
        src="{{asset('public-assets/assets/admin')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
