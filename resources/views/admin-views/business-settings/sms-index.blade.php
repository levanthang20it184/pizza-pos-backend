    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/third-party.png')}}" alt="">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center text-uppercase mb-1">
                            ...
                            <div class="pl-2">
                                <img src="{{asset('public-assets/assets/admin/img/twilio.png')}}" alt="public" style="height: 50px">
                            </div>
                        </div>
                        <div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center text-uppercase mb-1">
                            ...
                            <div class="pl-2">
                                <img src="{{asset('public-assets/assets/admin/img/2factor.png')}}" alt="public" style="height: 50px">
                            </div>
                        </div>
                        <div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center text-uppercase mb-1">
                            ...
                            <div class="pl-2">
                                <img src="{{asset('public-assets/assets/admin/img/signalwire.png')}}" alt="public" style="height: 50px">
                            </div>
                        </div>
                        <div>
                            <div class="px-2 d-inline-block rounded badge-soft-info mb-3 fz-12">{{translate('NB : #OTP# will be replace with otp')}}</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center text-uppercase mb-1">
                            ...
                            <div class="pl-2">
                                <img src="{{asset('public-assets/assets/admin/img/nexmo.png')}}" alt="public" style="height: 50px">
                            </div>
                        </div>
                        <div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center text-uppercase mb-1">
                            ...
                            <div class="pl-2">
                                <img src="{{asset('public-assets/assets/admin/img/msg91.png')}}" alt="public" style="height: 50px">
                            </div>
                        </div>
                        <div>
