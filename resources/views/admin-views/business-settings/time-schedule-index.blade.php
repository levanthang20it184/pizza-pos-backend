...
@push('css_or_js')
    <link href="{{asset('public-assets/assets/admin/css/croppie.css')}}" rel="stylesheet">
@endpush
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/business_setup2.png')}}" alt="">
