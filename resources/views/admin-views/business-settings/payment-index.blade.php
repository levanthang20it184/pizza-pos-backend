            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <center class="mb-4">
                            <img width="185" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/ssl.png')}}" alt="">
                        </center>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <center class="mb-4">
                            <img width="140" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/paypal.png')}}" alt="">
                        </center>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <center class="mb-4">
                            <img width="140" class="avatar-img" src="{{asset('public-assets/assets/admin/img/fluterwave.png')}}" alt="">
                        </center>
                            @if(isset($config))
                                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <center class="mb-4">
                            <img width="140" class="avatar-img" src="{{asset('public-assets/assets/admin/img/MercadoPago_(Horizontal).svg')}}" alt="">
                        </center>
                            @if(isset($config))
                                <div class="form-group">
                                    <label>{{translate('public_key')}}</label>
