...
@push('css_or_js')
    ...
    <link href="{{asset('public-assets/assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <style>
        td{
            white-space: nowrap;
            overflow: hidden;
...
@section('content')
    ...
    @push('script')
        <!-- Page level plugins -->
            <script src="{{asset('public-assets/assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
