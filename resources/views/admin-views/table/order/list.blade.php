                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{route('admin.table.order.list',['cooking'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset('public-assets/assets/admin/img/icons/cooking.png')}}" alt="dashboard" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{route('admin.table.order.list',['done'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset('public-assets/assets/admin/img/icons/review.png')}}" alt="dashboard" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{route('admin.table.order.list',['completed'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset('public-assets/assets/admin/img/icons/product.png')}}" alt="dashboard" class="oder--card-icon">
