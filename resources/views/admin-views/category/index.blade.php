    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/category.png')}}" alt="">
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img width="105" class="rounded-10 border" id="viewer"
                                                        src="{{ asset('public-assets/assets/admin/img/400x400/img2.jpg') }}" alt="image" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img width="500" class="rounded-10 border" id="viewer2"
                                                        src="{{ asset('public-assets/assets/admin/img/1920x400/img2.png') }}" alt="image" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="from_part_2">
                            ...
                            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                @foreach($categories as $key=>$category)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img width="50" class="avatar-img rounded" src="{{asset('storage/app/public/category')}}/{{$category['image']}}" onerror="this.src='{{asset('public-assets/assets/admin/img/icons/category_img.png')}}'" alt="">
                                            </div>
                                        </td>
