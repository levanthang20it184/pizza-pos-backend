            ...
            <ul class="list-inline-menu justify-content-center justify-content-md-end">
                <li>
                    <a href="{{route('admin.business-settings.restaurant.restaurant-setup')}}">
                        ...
                        <img width="12" class="avatar-img rounded-0" src="{{asset('public-assets/assets/admin/img/icons/business_setup.png')}}" alt="Image Description">
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('admin.settings')}}">
                        ...
                        <img width="12" class="avatar-img rounded-0" src="{{asset('public-assets/assets/admin/img/icons/profile.png')}}" alt="Image Description">
                    </a>
                </li>
