        ...
        <div class="col-md-12">
            <div id="loading" style="display: none;">
                <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                    <img width="200" src="{{asset('public-assets/assets/front-end/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
...
{{--<script src="{{asset('public-assets/assets/front-end')}}/vendor/jquery/dist/jquery.slim.min.js"></script>--}}
