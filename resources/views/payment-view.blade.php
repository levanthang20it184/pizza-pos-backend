...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public-assets/assets/admin')}}/css/bootstrap.css">
                                ...
                                <div class="card-body" style="height: 70px">
                                    <form action="{!! route('pay-ssl',['order_amount'=>$order_amount,'customer_id'=>$customer['id'],'callback'=>$callback]) !!}" method="POST" class="needs-validation"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('public-assets/assets/admin/img/sslcomz.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{asset('public-assets/assets/admin/img/razorpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    <form class="needs-validation" method="POST" id="payment-form"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('public-assets/assets/admin/img/paypal.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="checkout-button">
                                        <img width="100" src="{{asset('public-assets/assets/admin/img/stripe.png')}}"/>
                                    </button>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <button class="btn btn-block" type="button"
                                        ...
                                        <img width="100"
                                             src="{{asset('public-assets/assets/admin/img/paystack.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{asset('public-assets/assets/admin/img/senangpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    <button class="btn btn-block click-if-alone" id="bKash_button" onclick="BkashPayment()">
                                        <img width="100" src="{{asset('public-assets/assets/admin/img/bkash.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body" style="height: 70px">
                                    <form class="needs-validation" method="POST" id="payment-form-paymob"
                                        ...
                                        <button class="btn btn-block click-if-alone">
                                            <img width="100" src="{{asset('public-assets/assets/admin/img/paymob.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2" style="height: 70px">
                                    <button class="btn btn-block click-if-alone" onclick="location.href='{!! route('mercadopago.index',['order_amount'=>$order_amount,'customer_id'=>$customer['id'],'callback'=>$callback]) !!}'">
                                        <img width="150"
                                             src="{{asset('public-assets/assets/admin/img/MercadoPago_(Horizontal).svg')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2" style="height: 70px">
                                    <form method="POST" action="{!! route('flutterwave_pay',['order_amount'=>$order_amount,'customer_id'=>$customer['id'],'callback'=>$callback]) !!}">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="200"
                                                 src="{{asset('public-assets/assets/admin/img/fluterwave.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
...
<!-- JS Front -->
<script src="{{asset('public-assets/assets/admin')}}/js/jquery.js"></script>
<script src="{{asset('public-assets/assets/admin')}}/js/bootstrap.js"></script>
