...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public-assets/assets/mercado_pogo/css/index.css')}}">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://sdk.mercadopago.com/js/v2"></script>
    <!-- <script type="text/javascript" src="{{asset('public-assets/assets/mercado_pogo/js/index.js')}}" defer></script> -->
</head>
<body>
<main>
